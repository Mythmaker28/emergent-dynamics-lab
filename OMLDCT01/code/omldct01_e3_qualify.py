"""OMLDCT01 section 7 — PRE_RUN_E3_QUALIFICATION.

Two layers.

FIXTURE LAYER.  Classifier A's primitives (LDFMA01/code/ldfma01_raw.py: components_bfs, centroid,
link, link_reason) against classifier B's (omldct01_e3_b: _components_uf, _centroid, _link_map) on
...
daughter_particle_steps_after_t_m, computed by LDFMA01 before OMLDCT01 existed and committed — are
...
os.environ.setdefault("OMLDCT01_REPO", REPO)
sys.path.insert(0, os.path.join(REPO, "LDFMA01", "code"))
sys.path.insert(0, os.path.join(REPO, "OMLDCT01", "code"))
import numpy as np
import ldfma01_raw as A          # classifier A, frozen
import omldct01_e3_b as B        # classifier B, written for this qualification
...
if __name__ == "__main__":
    ...
    st = run_stress()
    out = {"MISSION": "OMLDCT01", "SECTION": "7 — PRE_RUN_E3_QUALIFICATION, fixture layer",
           "GENERATED_UTC": datetime.datetime.now(datetime.timezone.utc).isoformat(),
           "CLASSIFIER_A": "LDFMA01/code/ldfma01_raw.py — frozen, written before OMLDCT01 existed",
           "CLASSIFIER_B": "OMLDCT01/code/omldct01_e3_b.py — written for this qualification",
    ...
    p = os.path.join(REPO, "OMLDCT01", "out", "OMLDCT01_E3_QUALIFICATION_FIXTURES.json")

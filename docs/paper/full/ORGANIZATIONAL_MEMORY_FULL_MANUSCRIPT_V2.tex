...
\date{July 2026 \quad (Revised manuscript, V2, incorporating three referee reports)}
\begin{document}
\maketitle
...
tracer is passive and never enters --- ``turnover'' here is a bookkeeping construct on a passive cohort field, not a chemical exchange process, and the tracer $\rho,U,V,N,c$ \citep{jaqaman2008}. Interventions comprise erasure ($M_f=0$),

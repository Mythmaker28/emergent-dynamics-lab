...
| EXP02-COREV0-20260710-001 | PREREGISTERED | CORE V0 regime map | 0 | `docs/experiments/EXP02_COREV0_PROTOCOL.md` | 300 laws × 3 screening seeds; blocked only on tested streaming artifact writer |

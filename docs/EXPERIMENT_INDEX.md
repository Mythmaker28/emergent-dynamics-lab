...
| HOLDOUT-COREV0-20260710-003 | PREREGISTERED_CORRECTED | Repaired CORE V0 law 3 | 0 | `docs/experiments/HOLDOUT_COREV0_03_PROTOCOL.md` | Five unseen seeds; corrected clean-long-track cross-cadence rule |
| EXP02 | NOT_STARTED | CORE V0 regime map | 0 | protocol pending | Requires every first kill-switch gate green; 300–500 laws x 3 screening seeds |

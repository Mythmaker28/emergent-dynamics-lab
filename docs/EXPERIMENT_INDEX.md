...
| EXP02-COREV0-20260710-001 | COMPLETED_ANALYZED_9_ELIGIBLE | CORE V0 regime map | 900 | `results/EXP02-COREV0-20260710-001/` (raw local/ignored; committed index, analysis, figures) | Integrity PASS; integer-lag correction reproduces all rows; laws `{0,12,35,52,73,94,209,225,298}` pass frozen 2/3-seed permission gate, all alias-unresolved; direct audit precedes hold-out freeze |

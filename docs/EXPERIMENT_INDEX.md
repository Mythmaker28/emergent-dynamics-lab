...
| EXP02-COREV0-20260710-001 | RAW_COMPLETE_CANDIDATE_AUDITED | CORE V0 regime map | 900 | `results/EXP02-COREV0-20260710-001/` (raw local/ignored; root index/manifest tracked after analysis) | Integrity PASS; 9 laws pass frozen 2/3-seed screening permission gate, all retain alias risk; parent tau aggregate fragmented and preserved, corrected chunk-aware analysis pending |

...
| EXP02-COREV0-20260710-001 | PREREGISTERED_RECOVERY_GATE_PASS | CORE V0 regime map | 0 | `docs/experiments/EXP02_COREV0_PROTOCOL.md`; `edlab/experiments/streaming.py` | 300 laws × 3 screening seeds; 35 local tests plus independent `GO_AFTER_CLEAN_COMMIT`; launch awaits clean pushed SHA and exact-SHA smoke/recheck |

...
| ALIAS-INTERVENTION-COREV0-20260710-001 | DESIGN_ONLY | CORE V0 survivors `{0,52}` plus exact sham/alias-rejecting intervention | 0 | protocol pending independent design audit | Must reject stationary occupancy/look-alike flux without IDs in physics/association; no execution before frozen protocol and validated implementation |

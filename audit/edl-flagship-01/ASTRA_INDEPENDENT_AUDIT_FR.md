...
> **Mise à jour du 5 septembre, mission PAPER-01.** Cet audit initial est conservé comme étape de travail. Le bundle alors manquant est maintenant vérifié et les 28 findings sont adjudiqués dans [le rapport de septembre](september4_adjudication/SEPTEMBER4_ADJUDICATION_FR.md). Le manuscrit complet livré se trouve dans [le dossier article](../../paper/causal-persistence-ownership-01/README.md). Les assertions de source manquante et la décision de ne pas écrire ci-dessous décrivent exclusivement l'étape précédente, et sont remplacées par ces livrables. Le paragraphe de coût a été corrigé avec erratum explicite.
...
**Erratum de notre audit :** le coût à deux bras doit ajouter les continuations seulement aux graines effectivement forkées, identifiées par `ARCHIVES`, et non à tous les déclenchements. Douze triggers échouent avant fork. Le calcul corrigé franchit 512 à l'indice **789 avec 38 paires**, total **571,649364**; notre ancien résultat 760/36 était erroné et le checker avait raison sur ce décompte. Voir `september4_adjudication/PRIOR_ASTRA_COST_ERRATUM.json`. Le coût enregistré de TBRT02 concerne trois bras et franchit 512 à l'indice 738 : ce n'est pas la même quantité. Les 41 paires ne respectent pas l'acquisition gelée d'OMLDCT02. Employer **procédure statistique gelée sur données acquises hors de sa règle d'acquisition**, pas « expérience confirmatoire valide ».

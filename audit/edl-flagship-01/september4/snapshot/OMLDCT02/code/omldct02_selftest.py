"""OMLDCT02 §8 — deterministic self-tests of the five human-frozen decisions.
No scientific-scale trajectory is used anywhere in this file."""
from __future__ import annotations
import sys,json,hashlib,datetime,random
sys.path.insert(0,"/home/claude/edl/OMLDCT02/code")
import omldct02_analysis as A
OUT="/home/claude/edl/OMLDCT02/out"
...
tech={"case":"technical invalidity dominates a positive p",
 ...
 "with_a_pair_level_technical_fault":"OMLDCT02_TECHNICALLY_INVALID",
 "PASS":True,
...
art={"MISSION":"OMLDCT02","SECTION":"8 — five-line decision self-tests","GENERATED_UTC":U,
...
json.dump(art,open(f"{OUT}/OMLDCT02_FIVE_LINE_SELF_TEST.json","w"),indent=1)

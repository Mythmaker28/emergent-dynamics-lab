...
def main():
 ...
 row('Claude Sept-4 bundle / b64 / 246 files','NOT_LOCATED','Requested Edl recovery 20260904.bundle; SHA256 8c43b31d9311fa2cb51bab9fd055c1286eafe0b091d96bcd3ec0e106d934d46f','246 alleged files','129 local bundle headers plus disk remote prior-task and Drive search','Cannot verify extraction identity CCRA or 28 findings')
 ...
 row('OMLDCT03','VERIFIED_SAME_DATA_OUTSIDE_ACCRUAL','results/OMLDCT03_INDEPENDENT.json','41 paired original worlds','492 endpoint comparisons and 12 statistics match','512 two-arm ceiling reached at index 760 with 36 pairs; CI index error; competing terminations')
 ...
 for item in ['CCRA01 specification and blinding','CCRA01 raw classifications','CCRA01 capability 5/5','CCRA01 12h / 105h power','28 Sept-4 checker findings','Five Sept-4 fatal findings resolution']:
  row(item,'UNVERIFIED_SOURCE_MISSING','Announced Sept-4 bundle','UNKNOWN','None; binomial p=.8944882 verified only conditional on supplied counts','No inference that missing evidence passed')
 row('Exact eight missions missing in Claude','IDENTITIES_UNVERIFIED','Secondary quoted report','8 alleged missions','Independent inventory below establishes local availability','Cannot claim 8/8 restored without exact Claude file inventory')

"""Reproducible entry point for the EXP03-B orbital screen (frozen EXP03BConfig)."""
...
from .exp03b_orbital import EXP03BConfig, screen_records, assemble_summary
...
def write_screen(output_dir: Path, experiment_id: str, git_commit: str, protocol_sha: str,
                 cfg: EXP03BConfig, records: list[dict]) -> dict:
...
def main(argv=None) -> int:
    p = argparse.ArgumentParser(prog="edlab-exp03b")

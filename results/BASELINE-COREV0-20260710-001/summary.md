# BASELINE-COREV0-20260710-001 — Current Independently Executed Baseline
...
- Executed runs: 36.
- Measurement rows: 36722 (repeated tracks/lags; not independent replicates).
- P range: 0.2872975073660087 to 0.9999851363299829.
- M range: 0.0 to 1.0.
- Descriptive r(P,M): 0.7331624703861438.
- Initial exploratory probe count P>0.8, M<0.5: 384.
- Kill-switch gates: `{"cadence_control_nonempty": true, "id_permutation_null": true, "material_retention_varies": true, "phenotype_continuity_varies": true, "second_force_path": true, "static_flux_false_positive_null": true, "tracker_auditable": true, "tracker_cadence_sensitivity_null": true}`.

# HOLDOUT-COREV0-20260710-003 — Frozen Fresh-seed Hold-out
...
- Executed runs: 5.
- Measurement rows: 5885 (repeated tracks/lags; not independent replicates).
- P range: 0.3788317901562113 to 0.9999302200625705.
- M range: 0.0 to 1.0.
- Descriptive r(P,M): 0.6692090956691247.
- Initial exploratory probe raw count P>0.8, M<0.5: 30.
- Probe rows without logged ambiguity/split/merge inside the interval: 17.

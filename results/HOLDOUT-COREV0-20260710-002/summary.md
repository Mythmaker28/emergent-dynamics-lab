# HOLDOUT-COREV0-20260710-002 — Frozen Fresh-seed Hold-out
...
- Executed runs: 20.
- Measurement rows: 17448 (repeated tracks/lags; not independent replicates).
- P range: 0.2550023136719297 to 0.9999197194962368.
- M range: 0.0 to 1.0.
- Descriptive r(P,M): 0.7221226909461496.
- Initial exploratory probe raw count P>0.8, M<0.5: 254.
- Probe rows without logged ambiguity/split/merge inside the interval: 177.

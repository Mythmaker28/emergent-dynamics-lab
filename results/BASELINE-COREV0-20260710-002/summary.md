# BASELINE-COREV0-20260710-002 — Current Independently Executed Baseline
...
- Initial exploratory probe raw count P>0.8, M<0.5: 384.
- Probe rows without logged ambiguity/split/merge inside the interval: 230.

...
CAPS = {
    ...
    "calibration": 8,       # measurement of c_X at the pre-declared candidate points
    "confirmation": 6,      # independent seeds at the selected point
    "control": 10,          # the pre-declared controls
}
MAX_TEST_STEPS = 6000       # across the entire integrity harness, all worlds together
